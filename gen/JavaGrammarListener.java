...
public interface JavaGrammarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JavaGrammarParser#compactConstructorDeclaration}.
	 * @param ctx the parse tree
	 */
	void enterCompactConstructorDeclaration(JavaGrammarParser.CompactConstructorDeclarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaGrammarParser#compactConstructorDeclaration}.
	 * @param ctx the parse tree
	 */
	void exitCompactConstructorDeclaration(JavaGrammarParser.CompactConstructorDeclarationContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link JavaGrammarParser#typeIdentifier}.
	 * @param ctx the parse tree
	 */
	void enterTypeIdentifier(JavaGrammarParser.TypeIdentifierContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaGrammarParser#typeIdentifier}.
	 * @param ctx the parse tree
	 */
	void exitTypeIdentifier(JavaGrammarParser.TypeIdentifierContext ctx);
	/**
