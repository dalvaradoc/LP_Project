...
public interface JavaGrammarVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link JavaGrammarParser#compactConstructorDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCompactConstructorDeclaration(JavaGrammarParser.CompactConstructorDeclarationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link JavaGrammarParser#typeIdentifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTypeIdentifier(JavaGrammarParser.TypeIdentifierContext ctx);
	/**
